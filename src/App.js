  ...
  return (
    <div className="bg-gray-900 text-white min-h-screen font-sans">
      ...
      <section className="text-center py-20">
        <h1 className="text-5xl font-bold mb-4">Hi, I’m <span className="text-purple-400">Saran</span></h1>
      ...
      <section id="projects" className="py-20 px-4 max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-gray-800 p-4 rounded-lg hover:scale-105 transform transition">
            ...
            <a href="https://spotiver.netlify.app/" className="text-purple-400">View Demo →</a>
          </div>
          <div className="bg-gray-800 p-4 rounded-lg hover:scale-105 transform transition">
            <h3 className="text-xl font-semibold mb-2">Project 2</h3>
            <p className="mb-2">Description of your project.</p>
            <a href="www.google.com" className="text-purple-400">View Demo →</a>
          </div>
          <div className="bg-gray-800 p-4 rounded-lg hover:scale-105 transform transition">
            <h3 className="text-xl font-semibold mb-2">Project 3</h3>
            <p className="mb-2">Description of your project.</p>
            <a href="www.ign.com" className="text-purple-400">View Demo →</a>
          </div>
        </div>
      </section>
